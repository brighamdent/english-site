...
export default function Schedule({schedule, setSchedule, pricingStructure}) {
  ...
  return (
    <div className="md:w-[70%]flex flex-col items-center pl-4">
      ...
      { pricingStructure && pricingStructure.plan  != 3 ? <ul className="flex flex-col p-6">
      ...
      <ul className="flex flex-col p-6">
        <li onClick={handleClick} className="p-2 pb-4 border-b border-gray-300 text-xl hover:bg-gray-200 cursor-pointer">Lunes 5 PM</li>
        <li onClick={handleClick} className="p-2 pb-4 border-b border-gray-300 text-xl hover:bg-gray-200 cursor-pointer">Miercoles 5 PM</li>
        <li onClick={handleClick} className="p-2 pb-4 border-b border-gray-300 text-xl hover:bg-gray-200 cursor-pointer">Jueves 6 PM</li>
        <li onClick={handleClick} className="p-2 pb-4 border-b border-gray-300 text-xl hover:bg-gray-200 cursor-pointer">Jueves 7 PM</li>
        <li onClick={handleClick} className="p-2 pb-4 border-b border-gray-300 text-xl hover:bg-gray-200 cursor-pointer">Sabado 8 AM</li>
        <li onClick={handleClick} className="p-2 pb-4  text-xl hover:bg-gray-200 cursor-pointer">Sabado 12 PM</li>
      </ul>
      }
