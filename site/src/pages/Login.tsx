    ...
    <div>
      ...
      <div className="flex flex-col items-center pt-12 pb-12 p-4 sm:bg-white rounded-[10px] sm:w-[70vw] sm:shadow-sm text-2xl sm:text-3xl max-w-[500px]">
        <div className="mb-8">
          ...
          {error && (
            <div className="text-sm sm:text-lg flex items-center bg-red-200 text-red-500 border border-red-500 w-full rounded-md p-4 h-16 mb-4 max-w-[330px] sm:max-w-[400px]">
              <FontAwesomeIcon className="mr-4" icon={faCircleExclamation} />
              <h1>{error}</h1>
              <FontAwesomeIcon
                className="ml-6 lg:ml-[10px]"
                onClick={() => setError("")}
                icon={faXmark}
              />
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              disabled={loading}
              className="w-full bg-blue-200 hover:bg-blue-300 rounded-lg h-14"
            >
              Iniciar Sesión
            </button>
          </form>
        ...
        <div className="mb-2 text-xl">
          ...
          <Link
            className="text-blue-600 hover:border-b border-blue-600/20"
            to="/signup"
          >
            Registrarse
          </Link>
