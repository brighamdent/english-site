...
export function Home(){
  ...
  return(
    <div>
      <div className="text-center items-center flex-col-reverse flex xl:ml-64 xl:flex-row mt-[5%] sm:m-5 ">
      <div className=" flex items-center flex-col m-4 ">
        ...
        <Link to={subscribed ? '/dashboard' : '/pricing' } className=" rounded-lg bg-blue-200 hover:bg-blue-300 text-3xl p-5 m-10" >EMPIEZA YA!</Link>
      </div>
